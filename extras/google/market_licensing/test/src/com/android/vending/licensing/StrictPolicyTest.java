...
public class StrictPolicyTest extends TestCase {
    ...
    public void testLicensedResonse()  {
        StrictPolicy p = new StrictPolicy();
        p.processServerResponse(Policy.LicenseResponse.LICENSED, null);
        boolean result = p.allowAccess();
        assertTrue(result);
    }
    ...
    public void testNotLicensedResponse() {
        StrictPolicy p = new StrictPolicy();
        p.processServerResponse(Policy.LicenseResponse.NOT_LICENSED, null);
        boolean result = p.allowAccess();
        assertFalse(result);
    }
    ...
    public void testRetryResponse() {
        StrictPolicy p = new StrictPolicy();
        p.processServerResponse(Policy.LicenseResponse.RETRY, null);
        boolean result = p.allowAccess();
        assertFalse(result);
    }
